...
export const FooterSection = (): JSX.Element => {
  ...
  const navigationItems = [
    {
      icon: "data:image/svg+xml;base64," + btoa((isChallengePage || isQRCodePage || isMapPage || isAccountPage) ? `
    ...
    {
      icon: "data:image/svg+xml;base64," + btoa(isMapPage ? `
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      icon: "data:image/svg+xml;base64," + btoa(isAccountPage ? `
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clip-path="url(#clip0_40000004_2702)">
          ...
          <defs>
            <clipPath id="clip0_40000004_2702">
              <rect width="24" height="24" fill="white"/>
            </clipPath>
          </defs>
        </svg>
