...
export const FooterSection = (): JSX.Element => {
  ...
  // Define icons based on current page
  const isChallengePage = location === '/challenge';
  const isQRCodePage = location === '/qrcode';
  const isMapPage = location === '/map';
  
  // Navigation items data for the footer
  const navigationItems = [
    {
      icon: "data:image/svg+xml;base64," + btoa((isChallengePage || isQRCodePage || isMapPage) ? `
