  ...
  return (
    <div className="bg-[#e6f8f6] w-full min-h-screen">
      <div className="bg-[#e6f8f6] w-full relative">
        ...
        {/* Main Content */}
        <div className="flex-1 flex flex-col items-center justify-start pb-32 min-h-[calc(100vh-120px)] relative">
          {/* Map Container */}
          ...
          <div className="absolute top-4 left-0 right-0 flex items-center gap-4 w-full px-4 py-4 z-10">
            <div className="flex items-center gap-2 flex-1 h-12 px-4 border border-[#808080] rounded-lg bg-white shadow-sm">
